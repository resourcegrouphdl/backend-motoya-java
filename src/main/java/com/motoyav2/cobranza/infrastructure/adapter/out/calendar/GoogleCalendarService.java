...
public class GoogleCalendarService {
    ...
    // Mismo criterio que MigracionCalendarService / MigracionProperties.colorPagadoIds default.
    private static final Set<String> COLOR_IDS_PAGADA = Set.of("2", "10");
    ...
    public Flux<EventoCalendarioParseado> obtenerEventos(String calendarId) {
        return Mono.fromCallable(() -> {
                ...
                .flatMap(event -> {
                    ...
                    boolean pagada = COLOR_IDS_PAGADA.contains(event.getColorId());
